...
namespace Laravision\Visiteur\Http\Browser;   
/**
...
class BrowserDetection
{
     ...
     * @access private
     */
    public $_compatibilityViewName = '';
    /**
     * @var string
     * @access private
     */
    public $_compatibilityViewVer = '';
    /**
     * @var boolean
     * @access private
     */
    public $_is64bit = false;
    /**
     * @var boolean
     * @access private
     */
    ...
    public static function find($useragent){
    	...
    	return (new self)->__construct($useragent); 
